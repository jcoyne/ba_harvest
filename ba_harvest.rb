...
uri_str = ARGV[0]
unless uri_str
  $stderr.puts "You must supply a url"
  exit
end
...
recipe = { title: title, link: uri_str, thumbnail: thumbnail, servings: servings,
           ingredients: ingredient_list, preparation: preparation }

puts JSON.generate(recipe)
